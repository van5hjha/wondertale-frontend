                  ...
                  ? Row(
                      ...
                      children: [
                        Expanded(
                          child: MouseRegion(
                            onEnter: (_) =>
                                setState(() => _isSoftcoverHovered = true),
                            onExit: (_) =>
                                setState(() => _isSoftcoverHovered = false),
                            child: _buildPricingCard(
                              ...
                              originalPrice: '1,499',
                              description:
                                  'Perfect for lightweight reading & everyday bedtime story magic.',
                              features: [
                        ...
                        Expanded(
                          child: MouseRegion(
                            onEnter: (_) =>
                                setState(() => _isHardcoverHovered = true),
                            onExit: (_) =>
                                setState(() => _isHardcoverHovered = false),
                            child: _buildPricingCard(
                              context,
                              ...
                              originalPrice: '2,299',
                              description:
                                  'Our premium library-grade book. Built to last generations.',
                              features: [
                                '24-28 Custom Illustrated Pages',
                                'High-res AI Face Mapping',
  ...
  Widget _buildTrustBadges(BuildContext context, bool isDesktop) {
    final badges = [
      ...
      _buildBadgeItem(
        ...
        subtitle:
            '100% replacement in case of transit damage or printing defects.',
      ),
      _buildBadgeItem(
        context,
        ...
        subtitle:
            'Processed securely with standard encrypted payment gateways.',
      ),
    ];
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: Icon(icon, color: AppTheme.secondary, size: 24.0),
        ),
        const SizedBox(height: 12.0),
        Text(
          title,
